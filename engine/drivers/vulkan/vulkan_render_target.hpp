...
public:
    ...
    VulkanRenderTarget(VulkanRenderTarget&& other) = default;
    VulkanRenderTarget& operator=(VulkanRenderTarget&& other) = default;
    ...
    void push_constants(core::graphics::CommandBuffer* command_buffer, void* pipeline_layout, const void* data, size_t size, core::graphics::ShaderStageFlags stage_flags) override {
...
protected:
    ...
    std::vector<core::graphics::CommandBuffer*> _command_buffer_views;
